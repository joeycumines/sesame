...
func file_sesame_v1alpha1_remotecontrol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sesame_v1alpha1_remotecontrol_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_sesame_v1alpha1_remotecontrol_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_sesame_v1alpha1_remotecontrol_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_sesame_v1alpha1_remotecontrol_proto_msgTypes[3].Exporter = func(v any, i int) any {
