...
type TypeGrpcMetadata struct {
	Data *TypeGrpcMetadata_Data `json:"data,omitempty"`
}
...
// SesameProxyJSONBody defines parameters for SesameProxy.
type SesameProxyJSONBody V1alpha1ProxyRequest

// SesameUpdateEndpointJSONBody defines parameters for SesameUpdateEndpoint.
type SesameUpdateEndpointJSONBody V1alpha1Endpoint

// SesameUpdateEndpointParams defines parameters for SesameUpdateEndpoint.
type SesameUpdateEndpointParams struct {
	// https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask
	UpdateMask *string `json:"updateMask,omitempty"`
}

// SesameUpdateRemoteJSONBody defines parameters for SesameUpdateRemote.
type SesameUpdateRemoteJSONBody V1alpha1Remote

// SesameUpdateRemoteParams defines parameters for SesameUpdateRemote.
type SesameUpdateRemoteParams struct {
	// https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask
	UpdateMask *string `json:"updateMask,omitempty"`
}
...
// SesameCreateEndpointJSONBody defines parameters for SesameCreateEndpoint.
type SesameCreateEndpointJSONBody V1alpha1Endpoint
...
// SesameCreateRemoteJSONBody defines parameters for SesameCreateRemote.
type SesameCreateRemoteJSONBody V1alpha1Remote
...
// Override default JSON handling for TypeGrpcMetadata_Data to handle AdditionalProperties
func (a *TypeGrpcMetadata_Data) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for TypeGrpcMetadata_Data to handle AdditionalProperties
func (a TypeGrpcMetadata_Data) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
type ClientInterface interface {
	...
	SesameUpdateEndpointWithBody(ctx context.Context, name1 string, params *SesameUpdateEndpointParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	SesameUpdateEndpoint(ctx context.Context, name1 string, params *SesameUpdateEndpointParams, body SesameUpdateEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	SesameUpdateRemoteWithBody(ctx context.Context, name string, params *SesameUpdateRemoteParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	SesameUpdateRemote(ctx context.Context, name string, params *SesameUpdateRemoteParams, body SesameUpdateRemoteJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) SesameUpdateEndpointWithBody(ctx context.Context, name1 string, params *SesameUpdateEndpointParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSesameUpdateEndpointRequestWithBody(c.Server, name1, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SesameUpdateEndpoint(ctx context.Context, name1 string, params *SesameUpdateEndpointParams, body SesameUpdateEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSesameUpdateEndpointRequest(c.Server, name1, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SesameUpdateRemoteWithBody(ctx context.Context, name string, params *SesameUpdateRemoteParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSesameUpdateRemoteRequestWithBody(c.Server, name, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SesameUpdateRemote(ctx context.Context, name string, params *SesameUpdateRemoteParams, body SesameUpdateRemoteJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSesameUpdateRemoteRequest(c.Server, name, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewSesameUpdateEndpointRequest(server string, name1 string, params *SesameUpdateEndpointParams, body SesameUpdateEndpointJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewSesameUpdateEndpointRequestWithBody(server, name1, params, "application/json", bodyReader)
}

// NewSesameUpdateEndpointRequestWithBody generates requests for SesameUpdateEndpoint with any type of body
func NewSesameUpdateEndpointRequestWithBody(server string, name1 string, params *SesameUpdateEndpointParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewSesameUpdateRemoteRequest(server string, name string, params *SesameUpdateRemoteParams, body SesameUpdateRemoteJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewSesameUpdateRemoteRequestWithBody(server, name, params, "application/json", bodyReader)
}

// NewSesameUpdateRemoteRequestWithBody generates requests for SesameUpdateRemote with any type of body
func NewSesameUpdateRemoteRequestWithBody(server string, name string, params *SesameUpdateRemoteParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// SesameUpdateEndpoint request with any body
	SesameUpdateEndpointWithBodyWithResponse(ctx context.Context, name1 string, params *SesameUpdateEndpointParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SesameUpdateEndpointResponse, error)

	SesameUpdateEndpointWithResponse(ctx context.Context, name1 string, params *SesameUpdateEndpointParams, body SesameUpdateEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*SesameUpdateEndpointResponse, error)
	...
	// SesameUpdateRemote request with any body
	SesameUpdateRemoteWithBodyWithResponse(ctx context.Context, name string, params *SesameUpdateRemoteParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SesameUpdateRemoteResponse, error)

	SesameUpdateRemoteWithResponse(ctx context.Context, name string, params *SesameUpdateRemoteParams, body SesameUpdateRemoteJSONRequestBody, reqEditors ...RequestEditorFn) (*SesameUpdateRemoteResponse, error)
...
func (c *ClientWithResponses) SesameUpdateEndpointWithBodyWithResponse(ctx context.Context, name1 string, params *SesameUpdateEndpointParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SesameUpdateEndpointResponse, error) {
	rsp, err := c.SesameUpdateEndpointWithBody(ctx, name1, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SesameUpdateEndpointWithResponse(ctx context.Context, name1 string, params *SesameUpdateEndpointParams, body SesameUpdateEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*SesameUpdateEndpointResponse, error) {
	rsp, err := c.SesameUpdateEndpoint(ctx, name1, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSesameUpdateEndpointResponse(rsp)
...
func (c *ClientWithResponses) SesameUpdateRemoteWithBodyWithResponse(ctx context.Context, name string, params *SesameUpdateRemoteParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SesameUpdateRemoteResponse, error) {
	rsp, err := c.SesameUpdateRemoteWithBody(ctx, name, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SesameUpdateRemoteWithResponse(ctx context.Context, name string, params *SesameUpdateRemoteParams, body SesameUpdateRemoteJSONRequestBody, reqEditors ...RequestEditorFn) (*SesameUpdateRemoteResponse, error) {
	rsp, err := c.SesameUpdateRemote(ctx, name, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSesameUpdateRemoteResponse(rsp)
